$(document).ready(function(){
  ...
  $("#size").click(function(){
    ...
    for (var i = 0; i < windNum; i++) {
      var tempNum = i+1; 
      $(".calculator").append('<div class="window">    <p id="number" class="description">'+ tempNum +'-Window: </p>  <div class="description"><p class="description">Width (cm):	&nbsp;</p><input type="text" class="width" value="1">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</div>  <div class="description"><p class="description">Height (cm):	&nbsp;</p><input type="text" class="height" value="1">&nbsp;</div>  </div>');
    }
    $("#calc").show();
    $("#size").hide();
